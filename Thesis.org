...
# Linear translation
#+latex_header: \newcommand{\LinTrans}[1]{\llbracket #1 \rrbracket_L}
...
\noindent where X stands for an atomic proposition, and A and B stand for arbitrary intuitionistic propositions.
...
Verbally, the translation preserves the empty context, and it maps every judgment $J$ in $\Gamma$ (since assumptions in intuitionistic logic are simply judgments) to an intuitionistic assumption of the translation of the judgment.
